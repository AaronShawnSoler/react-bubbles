...
- [ ] Explain what a token is used for.
      a token is used to authenticate and verify the user that is trying to access data from the server.
- [ ] What steps can you take in your web apps to keep your data secure?
      I can require authentication for users trying to access my server while also blocking any users trying to access data without a token.
- [ ] Describe how web servers work.
      It's another computer somewhere else that we request the website and data from.
- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
      create can be post
      read can be get
      update can be put
      delete can be delete
